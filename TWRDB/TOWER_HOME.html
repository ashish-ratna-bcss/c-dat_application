...
<marquee behavior="scroll" direction="left"> <font color="YELLOW" face=verdana size='2'><b> *** PLEASE MAIL RAW DATA TO crimelab@hyd.tspolice.gov.in TO VIEW REPORTS *** </b></font></marquee> 
	  ...
	  <li><a href="HOME.HTML">HOME</a></li>
          <li><a href="SUS_SEARCH_TWR.HTML">Sus Search In Dump</a></li>
          <li><a href="OTHER_STATE_NOS_IN_TWR.HTML">Other State Numbers In Dump</a></li>
          <li><a href="INTER_TOWER_CALLS.HTML">Inter Tower Calls</a></li>
          <li><a href="PREVIOUS_OFFENDERS_IN_TWR.HTML">Previous Offenders In Dump</a></li>
                </ul>
        <p>&nbsp; </p>
      </blockquote></td>
