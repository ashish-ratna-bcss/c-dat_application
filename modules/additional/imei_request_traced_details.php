    ...
    if (empty($rows)) {
        ...
        foreach ($rows as $row) {
            ...
            cdat_sum_table_row([
                ...
                ['html' => '<a href="' . htmlspecialchars(cdat_page('imei_request_sum.php')) . '?PHONE_NO=' . cdat_sum_h(urlencode($phone)) . '">' . cdat_sum_h($phone) . '</a>', 'class' => 'sum-cell-num'],
                ['html' => '<a href="' . htmlspecialchars(cdat_page('imei_request_movements.php')) . '?PHONE_NO=' . cdat_sum_h(urlencode($phone)) . '">' . cdat_sum_h($phone) . '</a>', 'class' => 'sum-cell-num'],
