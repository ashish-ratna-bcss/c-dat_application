...
LEFT JOIN #S B ON  A.PHONE=B.PHONE";
        ...
        $headerRow = cdat_sum_fetch_one($st8) ?? ['PHONE' => $number, 'FIRST_CALL' => '', 'LAST_CALL' => '', 'NICKNAME' => '', 'ADDRESS' => ''];

        cdat_sum_render_results($headerRow, $contactRows, 'summary_between_dates.csv', 'Summary Between Dates');
