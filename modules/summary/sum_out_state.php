...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($number !== '') {
        ...
        $stateFilter = $state !== ''
            ? cdat_sum_sql_phone_area_state_filter('E.STATE', $state, true)
            : cdat_sum_sql_phone_area_state_expr('E.STATE') . " <> ''";
        ...
        $sql8 = "SELECT 'SUMMARY OF MOBILE NO: ' || ? || ' OTHER THAN ' || ? || ' STATE' as PHONE1";
