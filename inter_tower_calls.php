  ...
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="862" height="158" align="center">
        <tr>
          <th height="25" align="center" valign="middle" background="IMAGES/border.jpg" scope="col">INTER TOWER CALLS IN TOWER DUMP</th>
        </tr>
        <tr>
          <th width="782" align="center" valign="middle" background="IMAGES/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="inter_tower_calls_twr.php">
            <p>
