...
<table width="1021" height="163" align="center">
        <tr>
          <th height="31" align="center" valign="middle" background="IMAGES/BORDER.jpg" scope="col">JAIL RELEASE SEARCH BY NAME</th>
        </tr>
        <tr>
          <th width="782" align="center" valign="middle" background="IMAGES/BORDER.jpg" scope="col"><form id="form1" name="form1" method="post" action="JRMS_NAME_SEARCH.PHP">
                     
              Name:
              <input type="text" name="NAME" id="NAME" size="10" required="required"/>
