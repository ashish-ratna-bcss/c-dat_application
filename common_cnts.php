...
// Was COMMON_CNTS.HTML (form) + COMMON_CNTS.php (handler). The de-duplication
// kept only the handler, so opening this URL ran the whole temp-table pipeline
// on an undefined $_POST['PHONE_NO'] with no box to type numbers into.
$__submitted = ($_SERVER['REQUEST_METHOD'] === 'POST');

require_once __DIR__ . '/cdat_chrome.php';
cdat_page_top('Common Contacts');
?>
<style>
label textarea{
...
<table width="972">
  ...
  <tr>
    <th width="764" align="center" valign="middle" bgcolor="#A9D1F5" class="CDAT" scope="col">
      <form id="form1" name="form1" method="post" action="common_cnts.php" class="cdat-form">
        MOBILE NUMBERS:
