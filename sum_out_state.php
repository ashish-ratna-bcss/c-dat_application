...
// Was sum_out_state.htm (form) + sum_out_state.php (handler). The de-duplication kept only the
  ...
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="876" height="135" align="center">
        <tr>
          <th height="24" align="center" valign="middle" background="IMAGES/border.jpg" scope="col">SUMMARY OF MOBILE NUMBER OTHER THAN A STATE</th>
        </tr>
        <tr>
          <th height="103" align="center" valign="middle" background="IMAGES/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="sum_out_state.php">
