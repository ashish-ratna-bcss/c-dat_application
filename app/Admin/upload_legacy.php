 ...
 */
require_once dirname(__DIR__, 2) . '/activity_logger.php';
...
if (isset($_POST['ajax_action']) && $_POST['ajax_action'] === 'preview_cdr') {
    ...
    require_once dirname(__DIR__, 2) . '/excel_converter.php';
    ...
    try {
        ...
        $script = dirname(__DIR__, 2) . '/scripts/cdr_preview.py';
        $cmd = sprintf(
            '%s %s %s %s 150 2>&1',
            cdr_python_bin(),
...
if (isset($_POST['ajax_action']) && $_POST['ajax_action'] === 'approve_staging') {
    ...
    try {
        ...
        $cfg = require dirname(__DIR__, 2) . '/cdr_upload_config.php';
...
if (isset($_POST['ajax_action'])) {
    header('Content-Type: application/json');
    require_once dirname(__DIR__, 2) . '/sqlsrv_compat.php';
...
require_once dirname(__DIR__, 2) . '/cdr_upload_parser.php';
$config = require dirname(__DIR__, 2) . '/cdr_upload_config.php';
$modules = $config;
unset($modules['api']);
