...
<table width="1021" height="163" align="center">
        <tr>
          <th height="31" align="center" valign="middle" background="IMAGES/border.jpg" scope="col">PDACT SEARCH BY POLICE STATION</th>
        </tr>
        <tr>
          <th width="782" align="center" valign="middle" background="IMAGES/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="pdact_ps_wise_search_php.php">
