...
<th bgcolor=#921215><font size=2 face=verdana color='#F9FBFC'>LR_NAME</font</th>
...
echo "<td width=125px bgcolor=#C2E0FB><font size=1 face=verdana><center>". $row['LR_NAME'] ."<center></font></td>";
