...
<head>
  ...
  <title>Ganesh e-Pass Management System - Home</title>
...
<body>
 ...
 <?php include_once('includes/header.php');?>
  ...
  <section class="hero-banner text-center">
    <div class="container">
      <h1>Ganesh e-Pass Management System</h1>
...
$query ="SELECT * from tblpass where PassNumber like '%$sdata%'";

$st1 = sqlsrv_query( $conn, $query );

while( $row = sqlsrv_fetch_array( $st1, SQLSRV_FETCH_ASSOC) ) {  
      <tr align="center">
<td colspan="6" style="font-size:20px;color:blue">
 Pass ID:  echo ". $row['FullName'] ."</td></tr>;
