      ...
      <td width="1349" height="595" align="left" valign="top"><table width="1313" height="148">
        <tr>
          <td width="1265" height="134" align="center" valign="bottom" background="IMAGES/TOPBORDER.jpg"><ul id="MenuBar1" class="MenuBarHorizontal">
            <li><a href="HOME_IMEI.html">Home</a>              </li>
            <li><a href="#" class="MenuBarItemSubmenu">Summary</a>
              <ul>
                <li><a href="IMEI_REQUEST_SUM.HTML">Summary Total</a></li>
              </ul>
            </li>
            <li><a href="#" class="MenuBarItemSubmenu">Call Details</a>
              <ul>
                <li><a href="IMEI_REQUEST_MOVEMENTS.HTML"> MOVEMENTS </a></li>
	          </ul>
            </li>
            ...
            <li><a href="#" class="MenuBarItemSubmenu">Imei Search</a>
              <ul>
                <li><a href="IMEI_REQUEST_STATUS.html">Phones used in Imei</a></li>
                <li><a href="IMEI_REQUEST_STATUS.html">Imeis used in phone</a></li>
              </ul>
            </li>
