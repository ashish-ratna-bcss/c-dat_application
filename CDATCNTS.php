...
<div align="center">
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <p class="MenuBarItemHover">&nbsp;</p>
      <table width="625" height="94">
        <tr>
          <th height="21" bgcolor="#A9D1F5" class="CDAT" scope="col">CDAT CONTACTS OF MOBILE NUMBER</th>
        </tr>
        <tr>
        <form id="form1" name="form1" method="post" action="CDATCNTS1.php">
                 <th width="555" bgcolor="#A9D1F5" class="CDAT" scope="col">CDAT CONTACTS OF MOBILE NO:            <label for="textfield"></label>
