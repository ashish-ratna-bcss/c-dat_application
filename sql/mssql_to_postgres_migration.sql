...
CREATE TABLE IF NOT EXISTS upload_staging_batches (
    id              BIGSERIAL    PRIMARY KEY,
    job_id          BIGINT       NOT NULL REFERENCES document_jobs(id),
...
CREATE INDEX IF NOT EXISTS idx_document_jobs_module       ON document_jobs (module);
CREATE INDEX IF NOT EXISTS idx_user_activity_logs_user    ON user_activity_logs (username);
CREATE INDEX IF NOT EXISTS idx_upload_staging_job         ON upload_staging_batches (job_id);
