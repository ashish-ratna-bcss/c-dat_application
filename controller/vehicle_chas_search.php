...
// Was view/vehicle_chas_search.html (form) + controller/vehicle_chas_search.php (handler).
...
layout_begin("Vehicle Chas Search");
?>
<div align="center">
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="625" height="124">
        <tr>
          <th height="26" bgcolor="#A9D1F5" class="CDAT" scope="col">VEHICLE CHASSIS NUMBER SEARCH</th>
        </tr>
        <tr>
        <form id="form1" name="form1" method="post" action="vehicle_chas_search.php">
                 <th width="555" height="90" bgcolor="#A9D1F5" class="CDAT" scope="col"> VEHICLE CHAS NO:            <label for="textfield"></label>
            <input type="text" name="VEHICLE_CHAS_NO" id="CAF" placeholder="Enter Chassis No" required="required"/>
...
if (isset($_POST['VEHICLE_CHAS_NO'])){

$number=$_POST['VEHICLE_CHAS_NO'];
...
VEHICLE_TYPE, ENG_NO,CHAS_NO,CONVERT(VARCHAR,ISS_DT,106) AS ISSUED_DATE FROM CDATDUPL.[dbo].[CDAT_RTA] WHERE CHAS_NO LIKE '%'+'$number'";
