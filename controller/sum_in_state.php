...
// Was view/sum_in_state.html (form) + controller/sum_in_state.php (handler).
...
<div align="center">
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <p>&nbsp;</p>
      <table width="808" height="118" align="center">
        <tr>
          <th height="29" align="center" valign="middle" background="../assets/images/border.jpg" scope="col">SUMMARY OF MOBILE NUMBER WITH IN A STATE</th>
        </tr>
        <tr>
          <th align="center" valign="middle" background="../assets/images/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="sum_in_state.php">
            <label for="SUM" font face="verdana"> Mobile No:</label>
              <input type="text" name="PHONE_NO" id="SUM" placeholder="Enter Mobile No" required="required"/>
               State : 
               <select name="STATE" placeholder="Enter Mobile No" required="required">
<option value=" "></option>
