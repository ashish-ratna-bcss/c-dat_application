  ...
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="1126" height="120" align="center">
        <tr>
          <th height="21" align="center" valign="middle" background="../IMAGES/BORDER.jpg" scope="col">CALL DETAILS OF MOBILE NUMBER</th>
        </tr>
        <tr>
          <th align="center" valign="middle" background="../IMAGES/BORDER.jpg" scope="col"><form id="form1" name="form1" method="post" action="calldetails.php">
