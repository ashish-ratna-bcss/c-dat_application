...
// Was view/vehicle_eng_search.htm (form) + controller/vehicle_eng_search.php (handler).
...
layout_begin("Vehicle Eng Search");
?>
<div align="center">
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="625" height="124">
        <tr>
          <th height="26" bgcolor="#A9D1F5" class="CDAT" scope="col">VEHICLE ENGINE NUMBER SEARCH</th>
        </tr>
        <tr>
        <form id="form1" name="form1" method="post" action="vehicle_eng_search.php">
                 <th width="555" height="90" bgcolor="#A9D1F5" class="CDAT" scope="col"> VEHICLE ENG NO:            <label for="textfield"></label>
            <input type="text" name="VEHICLE_ENG_NO" id="CAF" placeholder="Enter Engine No" required="required"/>
...
if (isset($_POST['VEHICLE_ENG_NO'])){

$number=$_POST['VEHICLE_ENG_NO'];
...
VEHICLE_TYPE, ENG_NO,CHAS_NO,CONVERT(VARCHAR,ISS_DT,106) AS ISSUED_DATE FROM CDATDUPL.[dbo].[CDAT_RTA] WHERE ENG_NO LIKE '%'+'$number'";
