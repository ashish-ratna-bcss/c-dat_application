...
<tr>
  <td width="1349" height="595" align="left" valign="top"><table width="1313" height="148">
		...
		<li><a href="otherscdat.php">Others Cdat</a></li>
		    ...
		    <li><a href="fp_list.php">Undetected Cases List - 1</a></li>
                  </ul>
                </li>
		...
		<li><a href="login.php">IR FORMS</a></li>
		<li><a href="../view/ir_search.htm">IR Form Search By Name</a></li>
		<li><a href="../view/training_module1.htm">TRAININGS</a></li>
              </ul>
            </li>
          </ul></td>
        </tr>
...
<marquee behavior="scroll" direction="left"> <font color="YELLOW" face=verdana size='2'><b> *** PLEASE MAIL RAW DATA TO crimelab@hyd.tspolice.gov.in TO VIEW REPORTS *** </b></font></marquee> 
        <table width="1307" height="347">
         ...
         <li><a href="ir_search_test.php" class="confirm_selection">IR Form Search By Name</a></li>
	  <li><a href="../view/ir_search.htm" class="confirm_selection">IR Form Search By Name and Crime head</a></li>
 	  <li><a href="../view/ir_search_by_head_gender.htm" class="confirm_selection">IR Form Search By Gender and Head</a></li>          
        </ul>
        <p>&nbsp; </p>
      </blockquote></td>
            <td width="1015" height="24" align="left" valign="top"><p align="center" class="FONT">INTERROGATION REPORT ANALYSIS</p></td>
...
<td width="1015" height="24" align="center" valign="top"><font size="3" class="confirm_selection">*** NOW YOU CAN SEARCH INTERROGATION REPORT OF OFFENDER BY NAME ***</font></td>
<td width="62" rowspan="2">&nbsp;</td>
