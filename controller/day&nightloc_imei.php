  ...
  <table width="1323" height="603" border="2">
    <tr>
        ...
        <tr>
          <td width="1265" height="134" align="center" valign="bottom" background="../assets/images/topborder.jpg"><ul id="MenuBar1" class="MenuBarHorizontal">
            ...
            <li><a href="#" class="MenuBarItemSubmenu">Call Details</a>
              <ul>
                <li><a href="../view/imei_request_movements.htm"> MOVEMENTS </a></li>
	          </ul>
            </li>
            ...
            <li><a href="#" class="MenuBarItemSubmenu">Imei Search</a>
              <ul>
                <li><a href="../view/imei_request_status.htm">Phones used in Imei</a></li>
                <li><a href="../view/imei_request_status.htm">Imeis used in phone</a></li>
              </ul>
            </li>
      ...
      <table width="1126" height="144" align="center">
        ...
        <tr>
          <th align="center" valign="middle" background="../assets/images/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="d&n_loc_imei.php">
