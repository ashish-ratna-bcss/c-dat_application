...
<marquee behavior="scroll" direction="left"> <font color="YELLOW" face=verdana size='2'><b> *** PLEASE MAIL RAW DATA TO cdranalysiswing@gmail.com TO VIEW REPORTS *** </b></font></marquee> 
        <table width="1307" height="347">
          ...
          <li><a href="../view/address.htm">Address Search</a></li>
          <li><a href="cdatcnts.php">Cdat Cnts</a></li>
          <li><a href="../view/cellid_search.htm">Cellid Search</a></li>
          <li><a href="common_cnts.php">Common Cnts</a></li>
                <li><a href="admin_activity_log.php">User Activity</a></li>
          ...
          <li><a href="../view/vehicle_search_criteria.htm">Vehicle Search</a></li>
	  <li><a href="ir_module.php" class="confirm_selection">Interrogation Report Search</a></li>
	  <li><a href="../view/offender_search_by_mo.htm" class="confirm_selection">Offender Search By MO</a></li>
