...
// Was view/ir.htm (form) + controller/ir.php (handler).
...
<tr>
  <td width="1349" height="595" align="left" valign="top"><table width="1313" height="148">
        <tr>
          <td width="1265" height="134" align="center" valign="bottom" background="../assets/images/topborder.jpg"><ul id="MenuBar1" class="MenuBarHorizontal">
            <li><a href="../controller/home_ir.php">Home</a>              </li>
            <li><a href="irreport.php">IRREPORT</a></li>
            <li><a href="family_history.php">FAMILY HISTORY</a></li>
            <li><a href="../controller/home_ir.php" class="MenuBarItemSubmenu">CRIME DETAILS</a>
             <ul>
                <li><a href="offence_details.php">OFFENCE DETAILS</a></li>
                <li><a href="previous_offence_details.php">PREVIOUS OFFENCE DETAILS</a></li>
              </ul>
              </li>
            <li><a href="../controller/local_contacts.php">LOCAL CONTACTS</a></li>
            <li><a href="relation_with_other_associates_and_gangs.php">GANGS/ASSOCIATES</a></li>
            <li><a href="../controller/disposal_of_property.php">PROPERTY DETAILS</a></li>
            <li><a href="../controller/brief_facts.php">BRIEF FACTS</a></li>
        ...
        <table width="1307" height="347">
          ...
          <li><a href="../controller/local_contacts.php">LOCAL CONTACTS</a></li>
          <li><a href="relation_with_other_associates_and_gangs.php">GANGS/ASSOCIATES</a>            </li>
          <li><a href="../controller/disposal_of_property.php">PROPERTY</a></li>
          <li><a href="../controller/brief_facts.php">BRIEF FACTS</a></li>
          <li><a href="image_list.php">IMAGE</a></li>          
        </ul>
        <p>&nbsp; </p>
 ...
 <p class="MenuBarItemHover">&nbsp;</p>
      <table width="907" height="168">
        <tr>
          <th height="27" align="center" bgcolor="#A9D1F5" class="CDAT" scope="col">IR SEARCH</th>
        </tr>
        <tr>
        <form id="form1" name="form1" method="post" action="ir.php">
                 <th width="764" align="center" valign="middle" bgcolor="#A9D1F5" class="CDAT" scope="col"> IR NO:            
<style>
label textarea{
...
<label for="textfield"></label>
            <input type="text" name="IR_NO" id="CAF" placeholder="ENTER IR NO" required="required"/>
