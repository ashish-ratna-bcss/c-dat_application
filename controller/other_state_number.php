...
cdat_sum_search_card(
    'Other State Numbers In Tower Dump',
    'Search other-state numbers in tower dump for a crime and time window.',
    'other_state_number_twr.php',
    $fieldsHtml,
    'BTN_SUM',
    'Submit'
);
