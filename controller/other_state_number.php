...
layout_begin("Other State Number");
?>
  ...
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="862" height="158" align="center">
        <tr>
          <th height="25" align="center" valign="middle" background="../assets/images/border.jpg" scope="col">OTHER STATE NUMBERS IN TOWER DUMP</th>
        </tr>
        <tr>
          <th width="782" align="center" valign="middle" background="../assets/images/border.jpg" scope="col"><form id="form1" name="form1" method="post" action="other_state_number_twr.php">
            <p>
