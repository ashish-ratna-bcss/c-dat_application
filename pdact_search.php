...
// Was pdact_search.htm (form) + pdact_search.php (handler). The de-duplication kept only the
  ...
  <table width="1323" height="603" border="2">
    <tr>
      ...
      <table width="862" height="158" align="center">
        <tr>
          <th height="25" align="center" valign="middle" background="IMAGES/border.jpg" scope="col">PDACT SEARCH BY NAME</th>
        </tr>
        <tr>
          <th width="782" align="center" valign="middle" background="IMAGES/border.jpg" scope="col"><form id="form1" name="form1" method="POST" action="pdact_search.php">
            <p>
               ACCUSED NAME:
